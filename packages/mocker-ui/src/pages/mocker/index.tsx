                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (newFormat === 'object') {
                      ...
                      dispatch({
                        modalBody: JSON.stringify({ code: 200, data: { id: '@id', name: '@name', email: '@email' }, message: 'success' }, null, 2)
                      })
                      ...
                      dispatch({
                        modalBody: JSON.stringify({ code: 200, data: { '_|rows': { id: '@id', name: '@name' }, total: '@integer(20, 100)' }, message: 'success' }, null, 2)
                      })
